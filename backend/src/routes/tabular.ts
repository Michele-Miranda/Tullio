...
function buildTabularMessages(
    ...
    const systemContent = `You are Tullio, an AI legal assistant for Italian lawyers. Respond in Italian by default. You are helping with the tabular review titled "${reviewTitle}".
