            ...
            <div className="flex-1 overflow-y-auto bg-white">
                <div className="flex items-start justify-between px-8 py-4">
                    <div className="flex items-center gap-1.5 text-2xl font-medium font-serif">
                        <span className="text-gray-400">{t("breadcrumbProjects")}</span>
    ...
    return (
        <div className="flex-1 overflow-y-auto bg-white flex flex-col h-full">
                ...
                <div>
                    <div className="flex items-center gap-1.5 text-2xl font-medium font-serif">
                        ...
                        {tab !== "documents" && (
                            <>
                                <span className="text-gray-300">›</span>
                                <span className="text-gray-900">{tab === "assistant" ? t("tabAssistant") : t("tabReviews")}</span>
                            </>
                        )}
                    </div>
                </div>
                <div className="flex items-center gap-2">
                    <HeaderSearchBtn value={search} onChange={setSearch} placeholder={tSearch("placeholder")} />
                    <button
                ...
                {tab === "documents" && (
                    <div className="flex-1 flex flex-col min-h-0">
                        ...
                        <div className="flex items-center h-8 pr-8 border-b border-gray-200 text-xs text-gray-500 font-medium select-none shrink-0">
                            ...
                            <div className="ml-auto w-20 shrink-0 text-left">{t("colTypeShort")}</div>
                            <div className="w-24 shrink-0 text-left">{t("colSizeShort")}</div>
                            <div className="w-20 shrink-0 text-left">{t("colVersionShort")}</div>
                        ...
                        {contextMenu && (
                            ...
                            >
                                ...
                                >
                                    ...
                                    {contextMenu.showFolderActions ? t("newSubfolderInside") : t("newSubfolder")}
                                </button>
                ...
                {tab === "assistant" && (
                    <>
                        <div className="flex items-center h-8 pr-8 border-b border-gray-200 text-xs text-gray-500 font-medium select-none">
                            ...
                            <div className="ml-auto w-32 shrink-0 text-left">{t("colCreated")}</div>
                            <div className="w-8 shrink-0" />
                        </div>
                        {chats.length === 0 ? (
                            <div className="flex flex-col items-start py-24 w-full max-w-xs mx-auto">
                                <MessageSquare className="h-8 w-8 text-gray-300 mb-4" />
                                <p className="text-2xl font-medium font-serif text-gray-900">{t("assistantTitle")}</p>
                                <p className="mt-1 text-xs text-gray-400 max-w-xs">{t("assistantHint")}</p>
                                        ...
                                        <div className="w-8 shrink-0 flex justify-end" onClick={(e) => e.stopPropagation()}>
                                            <RowActions
                                                onRename={() => {
                                                    ...
                                                    setRenameChatValue(chat.title ?? t("untitledChat"));
                    ...
                    <>
                        ...
                        {projectReviews.length === 0 ? (
                            <div className="flex flex-col items-start py-24 w-full max-w-xs mx-auto">
                                ...
                                <p className="text-2xl font-medium font-serif text-gray-900">{t("reviewsTitle")}</p>
                                <p className="mt-1 text-xs text-gray-400 max-w-xs">{t("reviewsHint")}</p>
                                        ...
                                        <div className="w-8 shrink-0 flex justify-end" onClick={(e) => e.stopPropagation()}>
                                            <RowActions
                                                onRename={() => {
                                                    ...
                                                    setRenameReviewValue(review.title ?? t("untitledReview"));
            ...
            <AddDocumentsModal
                ...
                breadcrumb={[t("breadcrumbProjects"), project.name + (project.cm_number ? ` (${project.cm_number})` : ""), t("addDocumentsBreadcrumb")]}
                projectId={projectId}
            />
