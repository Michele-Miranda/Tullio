...
export function NewProjectModal({ open, onClose, onCreated }: Props) {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            setError((err as Error).message || tCommon("saveFailed"));
        } finally {
            setLoading(false);
        }
    }
                ...
                <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
                    <div className="px-6 pt-3 pb-5 flex-1 overflow-y-auto">
                        ...
                        <input
                            ...
                            placeholder={t("matterNumberPlaceholder")}
                        ...
                        <div className="mt-4 flex flex-wrap items-center gap-2">
                            ...
                            >
                                ...
                                {t("addPeople")}{sharedEmails.length > 0 ? ` (${sharedEmails.length})` : ""}
                            </button>
                        </div>
                        ...
                        <div className="mt-4 space-y-2">
                            <p className="text-xs font-medium text-gray-700">{tDocs("title")}</p>
                                <FileDirectory
                                    ...
                                    emptyMessage={tDocs("noDocuments")}
                                />
                    ...
                    <div className="flex items-center justify-between border-t border-gray-100 px-6 py-4 shrink-0">
                        <div className="flex items-center gap-2">
                            ...
                            >
                                ...
                                {tDocs("uploadFiles")}{pendingFiles.length > 0 ? ` (${pendingFiles.length})` : ""}
                            </button>
                        </div>
                        <div className="flex items-center gap-2">
                            <button
                            ...
                            >
                                {loading ? `${tCommon("loading")}` : t("createProject")}
                            </button>
                        </div>
                    </div>
                </form>
